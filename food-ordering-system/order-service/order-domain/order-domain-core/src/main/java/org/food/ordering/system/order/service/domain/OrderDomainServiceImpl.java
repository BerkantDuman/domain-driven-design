...
public class OrderDomainServiceImpl implements OrderDomainService {
    ...
    @Override
    public OrderCreatedEvent validateOrderAndInitiateOrder(Order order, Restaurant restaurant) {
    ...
    @Override
    public OrderPaidEvent validateOrderAndInitiateOrder(Order order) {
        order.pay();
